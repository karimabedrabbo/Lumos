...
model.load_weights("new_h5_files/rim-one-second.hdf5")
...
# output = Image.fromarray(pred[0], 'RGB')
# output.show()
...
# toimage(arr).show()
# toimage(arr).save("Glauc1-in.jpg")
...
# # pred = model.predict(arr)[0, 0] > 0.5
...
# output = toimage(pred)
# output.show()
# output.save("not_normalized_grayscale.jpg")
