...
def get_model(weights_path=None):
    ...
    model.add(Conv2D(32, (2, 2),input_shape=(5, 5, 512)))
...
Inception = keras.applications.inception_v3.InceptionV3(input_shape=(175, 175, 3), weights='imagenet', include_top=False)

Inception.summary()

featurized_training_data = Inception.predict(X_train, verbose=1)
featurized_test_data = Inception.predict(X_test, verbose=1)
